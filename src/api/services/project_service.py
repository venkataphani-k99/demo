...
class ProjectService:
    ...
    def create_project(self, filename: str, content: bytes) -> Dict[str, Any]:
        ...
        if suffix not in valid_extensions:
            raise ValueError(f"Unsupported file extension '{suffix}'. Supported formats: {', '.join(sorted(valid_extensions))}")
    ...
    def get_artifact_path(self, project_id: str, artifact_id: str) -> Path:
        ...
        fallbacks = {
            ...
            "industrial_drawing_svg": [pdir / f"{base_name}_industrial_drawing.svg"],
