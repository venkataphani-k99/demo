...
export const EngineeringIssuesPanel: React.FC<EngineeringIssuesPanelProps> = ({
  ...
  return (
    <div className="space-y-4">
      {/* Header Banner */}
      <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-4 backdrop-blur-md shadow-xl flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-white">Engineering Issues & Human Review Gate</h3>
      ...
      {actionSuccessMessage && (
        <div className="rounded-lg border border-emerald-500/30 bg-emerald-500/10 p-3 text-xs text-emerald-300 flex items-center space-x-2 animate-in fade-in">
      ...
      <div className="space-y-4">
        {issues.map((issue) => {
          ...
          return (
            <div
              key={issue.issue_id}
              className="rounded-xl border border-slate-800 bg-slate-900/70 p-5 backdrop-blur-md shadow-xl transition-all hover:border-slate-700/80"
            >
              {/* Issue Top Header */}
              <div className="flex flex-wrap items-start justify-between gap-2 border-b border-slate-800/80 pb-3">
                <div className="space-y-1">
                  <div className="flex items-center space-x-2">
                    <span className="font-mono text-sm font-bold text-white">{issue.issue_id}</span>
                    <span
