    ...
    <div className="rounded-xl border border-slate-800 bg-slate-900/60 overflow-hidden backdrop-blur-md shadow-xl flex flex-col">
      ...
      <div className="border-b border-slate-800 bg-slate-950/80 px-4 py-3 space-y-3">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center space-x-2">
            ...
            <h3 className="text-sm font-semibold text-white">Recognized Engineering Features</h3>
          ...
          <div className="flex items-center space-x-2 text-xs text-slate-400">
            ...
            <span className="font-mono text-emerald-300">100% Deterministic OCCT Engine</span>
          </div>
        </div>
      ...
      <div className="overflow-x-auto max-h-[560px]">
        <table className="w-full text-left text-xs">
          <thead className="sticky top-0 bg-slate-950/95 text-slate-400 border-b border-slate-800 z-10">
            <tr>
              <th className="py-2.5 px-3 font-medium">Feature ID</th>
              <th className="py-2.5 px-3 font-medium">Type</th>
              <th className="py-2.5 px-3 font-medium">Size / Dimensions</th>
              <th className="py-2.5 px-3 font-medium">Axis / Location</th>
              <th className="py-2.5 px-3 font-medium">B-Rep Faces</th>
